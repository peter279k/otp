...
class GoogleAuthenticator {
    protected static $allowedTypes = ['hotp', 'totp'];
     ...
     */
    public static function getKeyUri($type, $label, $secret, $counter = null, $options = []) {
        // two types only..
        ...
        $otpauth = 'otpauth://' . $type . '/' . \str_replace([':', ' '], ['%3A', '%20'], $label) . '?secret=' . \rawurlencode($secret);
     ...
     */
    public static function getQrCodeUrl($type, $label, $secret, $counter = null, $options = []) {
